...
| REQ-040 | 1 | planned | HTTP behavior shall provide stable typed errors, request IDs, secure headers, and bounded streaming. | WSL HTTP Transport | `HRD-015` | `daemon/src/browser_memory_daemon/app.py`<br>`daemon/src/browser_memory_daemon/http_server.py`<br>`daemon/src/browser_memory_daemon/routes.py`<br>`daemon/src/browser_memory_daemon/api_errors.py` | — |
