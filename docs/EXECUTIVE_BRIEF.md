...
- **Verification depth:** 336 static test functions across 60 files (263 daemon pytest; 73 extension node:test), plus real Chrome for Testing e2e.
- **Requirement authority:** `requirements/catalog.toml` defines 45 active and 0 planned stable requirements with generated traceability tables.
