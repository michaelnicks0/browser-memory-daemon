...
- **Verification depth:** 305 static test functions across 53 files (236 daemon pytest; 69 extension node:test), plus real Chrome for Testing e2e.
- **Requirement authority:** `requirements/catalog.toml` defines 41 active and 2 planned stable requirements with generated traceability tables.
