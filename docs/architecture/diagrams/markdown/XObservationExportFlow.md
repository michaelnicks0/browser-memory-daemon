...
> Generated Markdown wrapper for C4 view `XObservationExportFlow`. Canonical model: [`workspace.dsl`](../../workspace.dsl).

<!-- Generated from Structurizr exports; refresh from docs/architecture/workspace.dsl. -->

## Diagram

![X Observation Export Flow](../dot-rendered/structurizr-XObservationExportFlow.svg)
...
| Artifact | Link |
|---|---|
| Mermaid source | [`structurizr-XObservationExportFlow.mmd`](../structurizr-XObservationExportFlow.mmd) |
| Mermaid SVG | [`structurizr-XObservationExportFlow.svg`](../structurizr-XObservationExportFlow.svg) |
| Mermaid PNG | [`structurizr-XObservationExportFlow.png`](../structurizr-XObservationExportFlow.png) |
| DOT source | [`structurizr-XObservationExportFlow.dot`](../dot/structurizr-XObservationExportFlow.dot) |
| Graphviz SVG | [`structurizr-XObservationExportFlow.svg`](../dot-rendered/structurizr-XObservationExportFlow.svg) |
| Graphviz PNG | [`structurizr-XObservationExportFlow.png`](../dot-rendered/structurizr-XObservationExportFlow.png) |
