...
| REQ-033 — Visits, capture observations, snapshots, lifecycle events, and media provenance shall have explicit temporal relationships. | — | `daemon/tests/integration/test_capture_observations.py`<br>`daemon/tests/integration/test_observation_reads.py`<br>`daemon/tests/integration/test_visit_lifecycle.py::test_claimed_visit_identity_does_not_fall_back_by_url_and_reconciles_after_delayed_capture`<br>`daemon/tests/integration/test_migrations.py::test_version_five_backfills_only_evidence_supported_historical_relationships`<br>`daemon/tests/integration/test_migrations.py::test_version_six_backfills_only_unambiguous_media_observation_links`<br>`daemon/tests/integration/test_migrations.py::test_version_seven_preserves_claimed_visit_identity_for_historical_events` | `daemon/tests/e2e/test_admin_api.py`<br>`daemon/tests/e2e/test_http_api.py` | `docs/architecture/adr/0030-separate-capture-observations-and-url-claims.md`<br>`docs/architecture/adr/0031-dual-write-observed-url-capture-provenance.md`<br>`docs/architecture/adr/0032-link-media-artifacts-to-capture-observations.md`<br>`docs/architecture/adr/0033-use-observation-first-historical-activity-reads.md`<br>`docs/architecture/adr/0034-bind-lifecycle-by-visit-identity-and-union-dwell.md` | `daemon/tests/integration/test_observation_reads.py::test_observation_first_reads_preserve_contemporaneous_snapshots_and_unique_visit_summary`<br>`daemon/tests/integration/test_visit_lifecycle.py::test_claimed_visit_identity_does_not_fall_back_by_url_and_reconciles_after_delayed_capture` |
