...
| REQ-033 — Visits, capture observations, snapshots, lifecycle events, and media provenance shall have explicit temporal relationships. | — | `daemon/tests/integration/test_migrations.py::test_capture_observation_and_url_claim_schema_enforces_expand_contract` | — | `docs/architecture/adr/0030-separate-capture-observations-and-url-claims.md` | — |
| REQ-034 — The normalized observed browser URL shall control document identity while page-provided canonical and alternate URLs remain untrusted claims. | — | `daemon/tests/integration/test_migrations.py::test_capture_observation_and_url_claim_schema_enforces_expand_contract` | — | `docs/architecture/adr/0030-separate-capture-observations-and-url-claims.md` | — |
