...
| REQ-036 — Media transitions, cache admission, leases, retries, and resource budgets shall be closed, bounded, and concurrency-safe. | — | `daemon/tests/integration/test_media_storage.py::test_spool_reservations_serialize_concurrent_cap_checks`<br>`daemon/tests/integration/test_media_storage.py::test_concurrent_same_artifact_writers_hold_distinct_reservations`<br>`daemon/tests/integration/test_media_storage.py::test_spool_capacity_accounts_for_existing_files_and_exact_headroom`<br>`daemon/tests/integration/test_media_storage.py::test_unavailable_external_media_root_spools_then_drains_with_hash_verification` | `daemon/tests/e2e/test_http_api.py::test_http_upload_get_and_purge_use_bounded_spool_during_media_root_outage` | `docs/architecture/adr/0039-split-media-root-and-add-bounded-durable-spool.md` | `daemon/tests/integration/test_media_storage.py::test_spool_reservations_serialize_concurrent_cap_checks`<br>`daemon/tests/e2e/test_http_api.py::test_http_upload_get_and_purge_use_bounded_spool_during_media_root_outage` |
