...
| REQ-029 — Every blob read, write, move, and delete shall resolve under its configured root and resist traversal and symlink escape. | `daemon/tests/unit/test_blob_store.py`<br>`daemon/tests/unit/test_storage_paths.py` | `daemon/tests/integration/test_ingest_search_forget.py`<br>`daemon/tests/integration/test_media_worker.py` | `scripts/run-e2e.sh` | `docs/security-model.md`<br>`docs/architecture/adr/0036-route-blob-operations-through-contained-blobstore.md` | `daemon/tests/unit/test_blob_store.py::test_blob_store_stages_streams_verifies_hash_and_commits_atomically`<br>`daemon/tests/unit/test_blob_store.py::test_blob_store_rejects_traversal_symlink_escape_and_cross_root_stage`<br>`daemon/tests/integration/test_ingest_search_forget.py::test_blob_path_consumers_reject_db_paths_outside_configured_roots` |
...
| REQ-032 — Every supported database shall have an explicit version and ordered, auditable, restore-backed migrations. | — | `daemon/tests/integration/test_migrations.py` | `scripts/run-e2e.sh` | `docs/database-migrations.md`<br>`docs/architecture/adr/0028-use-versioned-restore-backed-sqlite-migrations.md` | `daemon/tests/integration/test_migrations.py::test_destructive_migration_creates_online_backup_that_restores_search` |
