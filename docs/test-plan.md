...
| REQ-033 — Visits, capture observations, snapshots, lifecycle events, and media provenance shall have explicit temporal relationships. | — | `daemon/tests/integration/test_capture_observations.py`<br>`daemon/tests/integration/test_observation_reads.py`<br>`daemon/tests/integration/test_migrations.py::test_version_five_backfills_only_evidence_supported_historical_relationships`<br>`daemon/tests/integration/test_migrations.py::test_version_six_backfills_only_unambiguous_media_observation_links` | — | `docs/architecture/adr/0030-separate-capture-observations-and-url-claims.md`<br>`docs/architecture/adr/0031-dual-write-observed-url-capture-provenance.md`<br>`docs/architecture/adr/0032-link-media-artifacts-to-capture-observations.md`<br>`docs/architecture/adr/0033-use-observation-first-historical-activity-reads.md` | — |
